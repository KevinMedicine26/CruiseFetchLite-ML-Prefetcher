...
SKIP_TRAINING=true # Whether to skip training and go directly to generation (true/false)
...
if [ "$SKIP_TRAINING" = true ]; then
    echo "===== SKIPPING TRAINING STEP (SKIP_TRAINING=true) ====="
    echo "Note: Make sure the model file exists at: $MODEL"
else
